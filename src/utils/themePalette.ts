...
export function buildThemeCssVars(palette: ThemePalette, modelName?: string): Record<string, string> {
  ...
  return {
    ...
    '--glass-bg': palette.surfaceGlass,
    '--glass-bg-hover': palette.surfaceGlassHover,
    '--glass-border': palette.borderSubtle,
    '--glass-border-hover': palette.borderStrong,
...
export function buildNaiveThemeOverrides(palette: ThemePalette): GlobalThemeOverrides {
  return {
    common: {
      ...
      modalColor: palette.surfaceFloating,
      popoverColor: palette.surfaceOverlay,
      inputColor: palette.surfaceRaised,
    ...
    Input: {
      ...
      colorFocus: palette.surfaceRaised,
      colorFocusError: palette.surfaceRaised,
      borderHover: `1px solid ${palette.borderStrong}`,
      borderFocus: `1px solid ${palette.borderAccent}`,
      boxShadowFocus: `0 0 0 3px ${palette.accentSoft}`,
    },
    Select: {
      peers: {
        InternalSelection: {
    ...
    DatePicker: {
      panelColor: palette.surfaceOverlay,
