export default {
  ...
  'settings.model.library.modelCount': '共 {count} 个模型',
  ...
  'settings.advanced.data.storageTitle': '本地存储概览',
  'settings.advanced.data.actionsTitle': '维护操作',
  'settings.advanced.data.refreshStorage': '刷新统计',
  'settings.advanced.data.storageLoadFailed': '加载存储统计失败: {error}',
  'settings.advanced.data.appDataPath': '数据目录',
  'settings.advanced.data.storageMode.development': '开发模式',
  'settings.advanced.data.storageMode.installed': '已安装',
  'settings.advanced.data.storageMode.portable': '便携版',
  'settings.advanced.data.metricDatabaseFile': '数据库文件',
  'settings.advanced.data.metricDatabaseVersion': 'Schema v{version}',
  'settings.advanced.data.metricResourceBlob': '消息内嵌媒体',
  'settings.advanced.data.metricResourceCount': '{count} 个文件',
  'settings.advanced.data.metricModelsDir': '模型库目录',
  'settings.advanced.data.metricModelCount': '{count} 个模型',
  'settings.advanced.data.metricLogs': '日志文件',
  'settings.advanced.data.metricLogFiles': '{count} 个文件',
  'settings.advanced.data.metricCubismCore': 'Live2D Core',
  'settings.advanced.data.cubismNotInstalled': '未安装',
  'settings.advanced.data.metricSessions': '会话数',
  'settings.advanced.data.metricMessageRows': '消息行 {count}',
  'settings.advanced.data.metricPerformances': '表演记录',
  'settings.advanced.data.metricPerformancesInterrupted': '被打断 {count} 次',
  'settings.advanced.data.metricResourceDedup': '媒体去重指纹',
  'settings.advanced.data.resourceBreakdownTitle': '内嵌媒体按类型',
  'settings.advanced.data.dataSpan': '消息时间跨度',
