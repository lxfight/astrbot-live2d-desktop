export default {
  ...
  'settings.page.advanced.windowWatcher.desc': '应用切换、当前上下文与主动感知配置。',
  ...
  'settings.advanced.personality.title': '人格 Pro',
  'settings.advanced.personality.description': '配置会在发送给 Bot 前注入，用于稳定角色口吻、边界和偏好。',
  'settings.advanced.personality.enabled': '启用人格注入',
  'settings.advanced.personality.injectIntoMessages': '注入到消息',
  'settings.advanced.personality.allowDesktopInterruption': '允许桌面主动打扰',
  'settings.advanced.personality.allowScreenshot': '允许截图上下文',
  'settings.advanced.personality.exclusiveNickname': '专属昵称',
  'settings.advanced.personality.proactiveLevel': '主动性',
  'settings.advanced.personality.sarcasm': '吐槽度',
  'settings.advanced.personality.affection': '亲近度',
  'settings.advanced.personality.professionalism': '专业度',
  'settings.advanced.personality.roastFrequency': '玩梗吐槽频率',
  'settings.advanced.personality.likedTopics': '喜欢的话题',
  'settings.advanced.personality.blockedTopics': '回避的话题',
  'settings.advanced.scenePro.title': '场景感知 Pro',
  'settings.advanced.scenePro.description': '触发 Bot 时读取当前活跃窗口并本地判断场景，再把结果作为上下文注入。',
  'settings.advanced.scenePro.enabled': '启用场景注入',
  'settings.advanced.scenePro.includeInPrompt': '注入到 Prompt',
  'settings.advanced.scenePro.adaptiveSuggestion': '启用自适应建议',
  'settings.advanced.scenePro.quietScenes': '安静场景',
  'settings.advanced.scenePro.activeScenes': '活跃辅助场景',
  'settings.advanced.scenePro.snapshot': '当前快照',
  'settings.advanced.scenePro.scene': '场景',
  'settings.advanced.scenePro.reason': '原因',
  'settings.advanced.scenePro.currentWindow': '当前窗口',
  'settings.advanced.scenePro.getSnapshot': '获取快照',
  ...
  'settings.advanced.watcher.awarenessTitle': '桌面感知',
  'settings.advanced.watcher.awarenessDesc':
    '让桌宠理解你正在使用的应用，并用更克制的方式向 AI 提供上下文。',
  'settings.advanced.watcher.enableAwareness': '启用桌面感知',
  'settings.advanced.watcher.awarenessMode': '主动程度',
  'settings.advanced.watcher.modeQuiet': '安静',
  'settings.advanced.watcher.modeSmart': '智能',
  'settings.advanced.watcher.modeActive': '积极',
  'settings.advanced.watcher.modeQuietDesc': '只更新当前上下文，不主动发送桌面事件。',
  'settings.advanced.watcher.modeSmartDesc': '默认推荐。应用明显切换并停留后，才发送上下文事件。',
  'settings.advanced.watcher.modeActiveDesc': '更快响应应用切换，适合想要更主动互动的场景。',
  'settings.advanced.watcher.appScope': '应用范围',
  'settings.advanced.watcher.appScopeDesc':
    '按真实应用身份匹配，不需要区分 chrome、chrome.exe 或 Google Chrome。',
  'settings.advanced.watcher.appScopeMode': '作用范围',
  'settings.advanced.watcher.scopeAll': '所有普通应用',
  'settings.advanced.watcher.scopeInclude': '仅这些应用',
  'settings.advanced.watcher.scopeExclude': '排除这些应用',
  'settings.advanced.watcher.scopeApps': '应用列表',
  'settings.advanced.watcher.scopeAppsPlaceholder': '例如：Chrome\nVS Code\nWeChat',
  ...
  'error.screenshotBlockedByPrivacy': '桌面感知隐私设置已禁止 AI 请求截图',
