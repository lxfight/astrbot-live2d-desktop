...
const en: I18nMessageSchema = {
  ...
  'settings.advanced.personality.title': 'Personality Pro',
  'settings.advanced.personality.description': 'These settings are injected before messages are sent to the bot to keep tone, boundaries and preferences stable.',
  'settings.advanced.personality.enabled': 'Enable personality injection',
  'settings.advanced.personality.injectIntoMessages': 'Inject into messages',
  'settings.advanced.personality.allowDesktopInterruption': 'Allow desktop interruption',
  'settings.advanced.personality.allowScreenshot': 'Allow screenshot context',
  'settings.advanced.personality.exclusiveNickname': 'Exclusive nickname',
  'settings.advanced.personality.proactiveLevel': 'Proactivity',
  'settings.advanced.personality.sarcasm': 'Sarcasm',
  'settings.advanced.personality.affection': 'Affection',
  'settings.advanced.personality.professionalism': 'Professionalism',
  'settings.advanced.personality.roastFrequency': 'Roast frequency',
  'settings.advanced.personality.likedTopics': 'Liked topics',
  'settings.advanced.personality.blockedTopics': 'Blocked topics',
  'settings.advanced.scenePro.title': 'Scene Awareness Pro',
  'settings.advanced.scenePro.description': 'When the bot is triggered, the active window is read and classified locally, then injected as runtime context.',
  'settings.advanced.scenePro.enabled': 'Enable scene injection',
  'settings.advanced.scenePro.includeInPrompt': 'Inject into prompt',
  'settings.advanced.scenePro.adaptiveSuggestion': 'Enable adaptive suggestion',
  'settings.advanced.scenePro.quietScenes': 'Quiet scenes',
  'settings.advanced.scenePro.activeScenes': 'Active assistant scenes',
  'settings.advanced.scenePro.snapshot': 'Current snapshot',
  'settings.advanced.scenePro.scene': 'Scene',
  'settings.advanced.scenePro.reason': 'Reason',
  'settings.advanced.scenePro.currentWindow': 'Current window',
  'settings.advanced.scenePro.getSnapshot': 'Get snapshot',
