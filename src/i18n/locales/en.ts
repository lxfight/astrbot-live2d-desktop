...
const en: I18nMessageSchema = {
  ...
  'expression.fearful': 'Nervous/Fearful',
  ...
  'expression.blushing': 'Blushing/Shy',
  'expression.playful': 'Playful',
  'expression.sweating': 'Sweating',
  ...
  'settings.advanced.behavior.fullPassThrough': 'Full pass-through',
  'settings.advanced.behavior.fullPassThroughFeedback': 'When enabled, the main window will continuously ignore mouse events; this mode takes priority over smart passthrough.',
  'settings.advanced.behavior.dynamicPassThrough': 'Smart passthrough',
  'settings.advanced.behavior.dynamicPassThroughFeedback': 'Only clickable when hovering over the model or interactive controls; other areas pass through to underlying applications.',
